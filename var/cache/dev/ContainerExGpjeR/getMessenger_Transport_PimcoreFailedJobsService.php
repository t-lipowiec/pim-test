 ...
 */
class getMessenger_Transport_PimcoreFailedJobsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.pimcore_failed_jobs' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.pimcore_failed_jobs'])) {
            return $container->privates['messenger.transport.pimcore_failed_jobs'];
        }

        return $container->privates['messenger.transport.pimcore_failed_jobs'] = $a->createTransport('doctrine://default?queue_name=pimcore_failed_jobs&table_name=messenger_messages_pimcore_failed', ['transport_name' => 'pimcore_failed_jobs'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
