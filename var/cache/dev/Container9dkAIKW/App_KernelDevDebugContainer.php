...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Main\\MainController' => 'getMainControllerService',
            ...
            'console.command.public_alias.App\\Command\\MyCommand' => 'getMyCommandService',
            'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Asset\\GenerateChecksumCommand' => 'getGenerateChecksumCommandService',
            'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Asset\\RemoveCustomSettingCommand' => 'getRemoveCustomSettingCommandService',
            ...
            'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\CleanupCommand' => 'getCleanupCommandService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $d->addInstance('pimcore.cache.adapter.redis_tag_aware', ($container->privates['pimcore.cache.adapter.redis_tag_aware'] ?? self::getPimcore_Cache_Adapter_RedisTagAwareService($container)));
    ...
    protected static function getStaticPageGeneratorService($container)
    {
        ...
        return $container->services['Pimcore\\Document\\StaticPageGenerator'] = new \Pimcore\Document\StaticPageGenerator($a, $b);
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZQ3BH0po-b', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bj9vccDwIG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FeEIxCFcrF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'Pimcore\\Bundle\\CoreBundle\\EventListener\\Frontend\\GlobalTemplateVariablesListener')] fn () => ($container->privates['Pimcore\\Bundle\\CoreBundle\\EventListener\\Frontend\\GlobalTemplateVariablesListener'] ?? self::getGlobalTemplateVariablesListenerService($container)), 'onKernelRequest'], 700);
    ...
    {
        $container->privates['Pimcore\\Bundle\\CoreBundle\\EventListener\\MaintenancePageListener'] = $instance = new \Pimcore\Bundle\CoreBundle\EventListener\MaintenancePageListener(($container->services['kernel'] ?? $container->get('kernel', 1)));
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ogf+kvN+S8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('maMls2hJO5', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KNILtStY1x', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0yPSDMgDJC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('71UFKFXrEU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CkyDjaPI8o', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
     ...
     */
    protected static function getPimcore_Cache_Adapter_RedisTagAwareService($container)
    {
        return $container->privates['pimcore.cache.adapter.redis_tag_aware'] = new \Symfony\Component\Cache\Adapter\TraceableTagAwareAdapter(($container->privates['pimcore.cache.adapter.redis_tag_aware.recorder_inner'] ?? self::getPimcore_Cache_Adapter_RedisTagAware_RecorderInnerService($container)));
    }
     ...
     */
    protected static function getPimcore_Cache_Adapter_RedisTagAware_RecorderInnerService($container, $lazyLoad = true)
    {
        if (true === $lazyLoad) {
            return $container->privates['pimcore.cache.adapter.redis_tag_aware.recorder_inner'] = $container->createProxy('RedisTagAwareAdapterGhost4d74e17', static fn () => \RedisTagAwareAdapterGhost4d74e17::createLazyGhost(static fn ($proxy) => self::getPimcore_Cache_Adapter_RedisTagAware_RecorderInnerService($container, $proxy)));
        }
        ...
        $instance = ($lazyLoad->__construct(\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('redis://localhost', ['lazy' => true]), 'WLRY16iB2v', 0, new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)) && false ?: $lazyLoad);

        $a = ($container->services['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container));
    ...
    protected static function getTwig_Runtime_HttpkernelService($container)
    {
        ...
        return $container->privates['twig.runtime.httpkernel'] = new \Symfony\Bridge\Twig\Extension\HttpKernelRuntime(new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'inline' => '?',
        ]), $a, true), new \Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator('/_fragment', new \Symfony\Component\HttpKernel\UriSigner('2MO9T5GaIXiEBjYbntH/Dzt4wpNuxZ8gRkLgtTRgUJQ='), $a));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'locale' => 'en',
            'secret' => '2MO9T5GaIXiEBjYbntH/Dzt4wpNuxZ8gRkLgtTRgUJQ=',
            ...
            'kernel.secret' => '2MO9T5GaIXiEBjYbntH/Dzt4wpNuxZ8gRkLgtTRgUJQ=',
                        ...
                        'thumbnails' => [
                            'definitions' => [
                                'demo' => [
                                    ...
                                    'rasterizeSVG' => false,
                                    'downloadable' => false,
                                    'modificationDate' => 1688730299,
                                    'creationDate' => 1688730299,
            ...
            'pimcore.service_controllers' => [
                'App\\Controller\\About\\AboutController' => 'App\\Controller\\About\\AboutController',
                'App\\Controller\\DefaultController' => 'App\\Controller\\DefaultController',
                'App\\Controller\\Main\\MainController' => 'App\\Controller\\Main\\MainController',
                'App\\Controller\\Product\\ProductController' => 'App\\Controller\\Product\\ProductController',
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\MyCommand',
                1 => 'console.command.public_alias.Pimcore\\Bundle\\DataHubBundle\\Command\\Configuration\\MigrateLegacyConfig',
                2 => 'console.command.public_alias.Pimcore\\Bundle\\DataHubBundle\\Command\\Configuration\\RebuildWorkspacesCommand',
                3 => 'console.command.public_alias.Pimcore\\Bundle\\DataHubBundle\\Command\\GraphQL\\RebuildDefinitionsCommand',
                4 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Asset\\GenerateChecksumCommand',
                5 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Asset\\RemoveCustomSettingCommand',
                ...
                15 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\CleanupCommand',
                16 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\GeneratePagePreviews',
                17 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Document\\MigrateElementsCommand',
                18 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\EmailLogsCleanupCommand',
                19 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\GenerateStaticPagesCommand',
                20 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalMigrationHelpersCommand',
                21 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalModelDaoMappingGeneratorCommand',
                22 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalUnicodeCldrLanguageTerritoryGeneratorCommand',
                23 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\LowQualityImagePreviewCommand',
                24 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MaintenanceModeCommand',
                25 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Migrate\\StorageCommand',
                26 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\Migrate\\ThumbnailsFolderStructureCommand',
                27 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\MysqlToolsCommand',
                28 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RecyclebinCleanupCommand',
                29 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RequirementsCheckCommand',
                30 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\ResetPasswordCommand',
                31 => 'console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\RunScriptCommand',
