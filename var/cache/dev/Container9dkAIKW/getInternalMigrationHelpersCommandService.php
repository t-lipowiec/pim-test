...
class getInternalMigrationHelpersCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command.public_alias.Pimcore\\Bundle\\CoreBundle\\Command\\InternalMigrationHelpersCommand'] = new \Pimcore\Bundle\CoreBundle\Command\InternalMigrationHelpersCommand(($container->privates['doctrine.migrations.dependency_factory'] ?? $container->load('getDoctrine_Migrations_DependencyFactoryService')), ($container->services['Pimcore\\Migrations\\FilteredTableMetadataStorage'] ??= new \Pimcore\Migrations\FilteredTableMetadataStorage()));
    }
}
