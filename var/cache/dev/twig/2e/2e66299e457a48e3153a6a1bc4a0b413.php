...
class __TwigTemplate_a046dbae4760d828d60bf68a851f89a6 extends Template
{
    private $source;
    private $macros = [];
...
{#            {% set backgroundImageUrl = '/bundles/pimcoreadmin/img/login/' ~ random(defaultImages) %}#}
        ...
        <div id=\"logo\">
            <img src=\"{{ path('pimcore_settings_display_custom_logo') ~ (adminSettings['branding']['login_screen_invert_colors'] ? '' : '?white=true') }}\">
        </div>
...
", "@PimcoreAdmin/admin/login/layout.html.twig", "/home/tomek/Projects/pim-test/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/layout.html.twig");
    }
